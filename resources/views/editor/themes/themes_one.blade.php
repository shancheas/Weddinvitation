...
<head>
    ...
    <meta name="csrf-token" content="Qf6adMCddBacOzwVN8NwAFlyrDJGLGhEI2PDki5Q">
    ...
    <link type="text/css" href="http://localhost:8000/argon/css/custom.css" rel="stylesheet">
</head>

<body class="">

<div class="main-content theme-one-main-bg">
            ...
            <div class="container">
                <div class="header-body mt-6 mb-4 ml-5">
                    <div class="owl-carousel text-center">
                        <div>
                            <h1 style="font-family: 'Lobster', cursive; font-size: 64px;"> Michael &
                                Julia<br>Wedding </h1>
                            <br><br>
...
<div class="row" style="background-color:#FBE1B6;">
    <div class="col-md-5 p-6 mt-8 mb-8">
        <div class="row">
            ...
            <div class="col-md-3">
                <img src="http://localhost:8000/argon/img/theme/ic_calendar.png" class="templates-img" />
            </div>
        </div>
    </div>
    <div class="col-md-2">
    ...
    <div class="col-md-5 p-6 mt-8 mb-8">
        <div class="row">
            <div class="col-md-3">
                <img src="http://localhost:8000/argon/img/theme/ic_marker.png" class="templates-img" />
            </div>
            <div class="col-md-6 text-center">
...
<div class="header py-3 py-lg-4" style="background-color:#FBAC91;">
    <div class="text-center">
        ...
        <div class="row mt-5 mb-7">
            <div class="col-md-4">
                <img alt="Awesome template" src="http://localhost:8000/argon/img/theme/template-1.png"
                     style="width: 75%; height: 240px;">
            </div>
...
<iframe class="c2125" frameborder="0" src="https://maps.google.com/maps?&z=1&t=q&output=embed"></iframe>
</body>
